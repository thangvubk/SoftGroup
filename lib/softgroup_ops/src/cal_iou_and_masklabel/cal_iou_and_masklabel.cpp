...
void get_mask_iou_on_cluster(at::Tensor proposals_idx_tensor, at::Tensor proposals_offset_tensor,
    ...
    get_mask_iou_on_cluster_cuda(nInstance, nProposal, proposals_idx, proposals_offset, instance_labels,
...
void get_mask_iou_on_pred(at::Tensor proposals_idx_tensor, at::Tensor proposals_offset_tensor,
    ...
    //output: proposals_iou (nProposal, total_nInst), float
    //output: mask_label (sumNPoint, 1), float
    get_mask_iou_on_pred_cuda(nInstance, nProposal, proposals_idx, proposals_offset, instance_labels,
...
void get_mask_label(at::Tensor proposals_idx_tensor, at::Tensor proposals_offset_tensor,
    ...
    //output: proposals_iou (nProposal, total_nInst), float
    //output: mask_label (sumNPoint, 1), float
    get_mask_label_cuda(nInstance, nProposal, iou_thr, proposals_idx, proposals_offset, instance_labels, instance_cls, 
