...
void global_avg_pool_fp(at::Tensor feats_tensor, at::Tensor proposals_offset_tensor, at::Tensor output_feats_tensor, int nProposal, int C);

void global_avg_pool_bp(at::Tensor d_feats_tensor, at::Tensor proposals_offset_tensor, at::Tensor d_output_feats_tensor, int nProposal, int C);
